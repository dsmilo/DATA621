...
```{r}
dfraw <- read.csv(url("https://raw.githubusercontent.com/dsmilo/DATA621/master/HW1/data/moneyball-training-data.csv"))
dfremove <- subset(dfraw, INDEX == 1347 | TEAM_BATTING_BB == 0 | TEAM_BATTING_SO < 308 | TEAM_BATTING_SO > 1535 | TEAM_BATTING_HR < 3 | TEAM_BATTING_HR > 264)$INDEX #Identify rows for removal, have zero strikeouts or bases stolen
