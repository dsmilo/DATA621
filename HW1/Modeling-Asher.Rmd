...
TEAM_PITCHING_SO | Outside of recognized records[link](http://www.baseball-almanac.com/recbooks/rb_strike2.shtml)
...
```{r}
dfraw <- read.csv(url("https://raw.githubusercontent.com/dsmilo/DATA621/master/HW1/data/moneyball-training-data.csv"))
dfremove <- subset(dfraw, TEAM_BATTING_SO == 0 | TEAM_PITCHING_SO == 0 | INDEX == 1347 | TEAM_BATTING_BB == 0 | TEAM_PITCHING_SO > 3400 | TEAM_PITCHING_BB == 0 )$INDEX #Identify rows for removal, have zero strikeouts or bases stolen
