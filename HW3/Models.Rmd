...
Full Basic Linear Regression, And Best Subsets Model with 4 predictors; The number of predictors (i.e. 4) is selected using BIC as a criterion. The minimum BIC occurs when 4 predictors are used, which are nox+age+rad+medv.
```{r}
