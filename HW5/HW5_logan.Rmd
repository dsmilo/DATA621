...
```{r appendix-a}
appendixA = data.frame(matrix(NA, nrow = 3335, ncol = 3))
appendixA[, 1] = test$IN
appendixA[, 2] = predicted_cases
appendixA[, 3] = predicted_cases_stars

names(appendixA) = c("Index", "Predicted Value", "Predicted Star Value")
