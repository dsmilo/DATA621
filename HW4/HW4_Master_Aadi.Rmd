...
#####Predicted Classifications for Test Data, Compared to Training Data
```{r, echo = FALSE}
pander(table(predicted_flag_bin))
pander(table(train_flag$TARGET_FLAG))
```


#####Predicted Amounts for Test Data, Compared to Training Data
```{r, echo = FALSE}
